...
<body>
  ...
  <script src="{{ asset('vendor/laravel-filemanager/js/bootstrap.js')}}"></script>
  <script src="{{ asset('vendor/laravel-filemanager/js/bootbox.js')}}"></script>
  <script src="{{ asset('vendor/laravel-filemanager/js/jqueryui.js')}}"></script>
