...
@section('title')
  <title>Struktur Organisasi - Bagian Pengadaan Barang/Jasa Pemerintah Kota Depok</title>
@endsection
@section('content')
@php
                  ...
                  <div class="row">
                    <div class="col-sm-16 sec-info">
                      <div class="text-danger sub-info-bordered">
                        <div class="time"><span class="ion-android-data icon"></span>{{ \Carbon\Carbon::parse($struktur->created_at)->toFormattedDateString() }}</div>
                        <div class="comments"><span class="ion-chatbubbles icon"></span>{{$struktur->view}}</div>
                      </div>
                      {!! $struktur->desc !!}
                    </div>
                  </div>
