            ...
            @foreach($newsbycat as $item)
                ...
                <div class="row">
                    ...
                    <div class="sec-info">
                        <h3>
                          @php
                              $isititle = explode(' ', $item->nama_regulasi);
                          @endphp
                          @if(count($isititle) > 8)
                              @for($i = 0; $i <= 8; $i++)
                                  {{ $isititle[$i] }}
                        ...
                        <div class="comment">&nbsp;&nbsp;&nbsp;<a href="{{asset($item->file)}}" onclick="adddownload({{$item->id}})" target="_blank"><span class="ion-android-download icon"></span> Unduh</a></div>
                        </div>
