...
@section('content')
    ...
    <div class="app-heading app-heading-bordered app-heading-page">
        <div class="title">
            <h1>Form Edit Web Rekanan</h1>
            <p>Berikut Adalah Halaman Form Edit Web Rekanan.</p>
        </div>               
    </div>
    <div class="app-heading-container app-heading-bordered bottom">
        <ul class="breadcrumb">
            ...
            <li class="active">Form Edit Web Rekanan</li>
        </ul>
    </div>
    <!-- END PAGE HEADING -->
    ...
    <div class="container">
        <div class="block block-condensed">
            ...
            <div class="app-heading app-heading-small">
                <div class="title">
                    <h2>Form Edit Rekanan</h2>
                </div>
            </div>
            <!-- END HEADING -->
            
            <div class="block-content">
                <form class="form-horizontal" method="POST" action="{{ route('webrekanan.update', $id) }}">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label class="control-label col-lg-2">Nama Web</label>
                        <div class="col-lg-9">
                        <input type="text" class="form-control" data-validation="required" placeholder="Nama Web" name="nama_web" id="nama_web" autocomplete="off" value="{{ $data->nama_web }}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            ...
                            <input id="thumbnail" readonly class="form-control" type="text" name="image" value="{{ $data->image }}">
                        </div>
                        <img id="holder" style="margin-top:15px;max-height:100px;" src="{{ $data->image }}">
                        </div>
                    </div>
